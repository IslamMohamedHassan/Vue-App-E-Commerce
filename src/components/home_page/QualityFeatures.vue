<template>
    <div class="quality-features py-12 bg-grey-lighten-2">
        <v-container fluid>
            <v-row>
                <v-col cols="12" sm="6" md="4" lg=""  v-for="(card, i) in cards" :key="i">
        ...
        return {
            cards: [
                ...
                },
                {
                    ...
                    text: "More than 10 different secure payment methods",
                ...
                },
                {
                    ...
                    text: "24/7 Customer Service - We’re here and happy to help!",
