        ...
        <v-container fluid>
            <v-row >
                ...
                <v-col class="d-flex justify-center align-center flex-column flex-sm-row mx-sm-0" cols="12" sm="6" md="4" lg="4">
                    ...
                    <span class="font-weight-bold text-h5">Longest Warranties Offer</span>
                </v-col>
            </v-row>
        </v-container>
    </div>
