        ...
        <v-row class="align-center pt-2">
          ...
          <v-col cols="5">
            <div style="position: relative; width: 85%">
              <input
                style="outline: none; border-radius: 30px"
                class="bg-white out-l py-3 px-5 w-100"
                type="search"
                name="searchbar"
                id="searchbar"
          ...
          <v-col class="d-flex justify-space-around align-center" cols="4">
            <div class="d-flex flex-column align-center" style="width: 40%;">
              <span class="d-block">Available 24/7 at</span>
              <span><strong>(090)123-4567</strong></span>
            </div>
            <div  class="d-flex flex-column align-center" style=" cursor:pointer">
              <svg
                viewBox="0 0 512 512"
                class="icon icon-wishlist d-block"
                style="width: 35px; fill: #f7a833"
              >
                <g>
                  <g>
                        <path
