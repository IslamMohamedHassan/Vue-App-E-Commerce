                        ...
                        <div class="footer-col d-flex flex-column align-center w-100">
                            <div class="last-col w-100">
                                ...
                                <div class="mt-5 d-flex" style="gap: 10px;">
                                    ...
                                    <span class="">685 Market Street San <br> Francisco, CA 94105, US</span>
                                </div>
                                <div class="mt-5 d-flex" style="gap: 10px;">
                                    <svg fill="#555" style="color: #444; width: 22px;" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="phone-alt" role="img" viewBox="0 0 512 512"
                                        class="align-self-start pt-2 svg-inline--fa fa-phone-alt fa-w-16 fa-7x">
                                        <path fill="currentColor"
                                            d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"
                                            class=""></path>
                                    </svg>
                                    <span class="">Call us at (415) 555-5555</span>
                                ...
                                <!-- <div class="mt-5 d-flex flex-row flex-wrap">
                                    <ul class="icons d-flex flex-row align-center" style="gap:25px;" role="list">
                                        ...
                                        <li class="list-social__item">
                                            <a href="#">
                                                <svg fill="#fff" style="color: white; width: 30px;"
                                        ...
                                        <li class="list-social__item">
                                            <a href="#">
                                                <svg fill="#fff" style="color: white; width: 30px;" aria-hidden="true"
                                                    focusable="false" role="presentation" class="icon icon-pinterest"
                                                    viewBox="0 0 17 18">
                                                    <path
                                        ...
                                        <li class="list-social__item">
                                            <a href="#">
                                                <svg fill="#fff" style="color: white; width: 30px;"
                                                    xmlns="http://www.w3.org/2000/svg" class="icon icon-snapchat"
                                                    viewBox="0 0 50 50">
                                                    <path
                                        ...
                                        <li class="list-social__item">
                                            <a href="#">
                                                <svg fill="#fff" style="color: white; width: 30px;" aria-hidden="true"
                                                    focusable="false" role="presentation" class="icon icon-twitter"
                                                    viewBox="0 0 18 15">
                                                    <path
